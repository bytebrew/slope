...
void slope_view_write_to_png (SlopeView *self, const char *filename,
...
static gboolean
_view_on_draw (GtkWidget *self, cairo_t *cr, gpointer data) {
    SlopeViewPrivate *priv = SLOPE_VIEW_GET_PRIVATE(self);
...
static gboolean
_view_on_mouse_event (GtkWidget *self, GdkEvent *gdk_event, gpointer data) {
    SlopeViewPrivate *priv = SLOPE_VIEW_GET_PRIVATE(self);
...
static void
_view_set_figure (SlopeView *self, SlopeFigure *figure) {
    SlopeViewPrivate *priv = SLOPE_VIEW_GET_PRIVATE(self);
