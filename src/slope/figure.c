...
static void _figure_draw_background (SlopeFigure *self, const SlopeRect *rect, cairo_t *cr);
static void _figure_draw_scales (SlopeFigure *self, const SlopeRect *rect, cairo_t *cr);
static void _figure_draw_legend (SlopeFigure *self, const SlopeRect *rect, cairo_t *cr);
...
static void
_figure_draw_background (SlopeFigure *self, const SlopeRect *rect, cairo_t *cr) {
    SLOPE_UNUSED(rect);
    SlopeFigurePrivate *priv = SLOPE_FIGURE_GET_PRIVATE(self);
...
static void
_figure_draw_scales (SlopeFigure *self, const SlopeRect *rect, cairo_t *cr) {
    SlopeFigurePrivate *priv = SLOPE_FIGURE_GET_PRIVATE(self);
...
static void
_figure_clear_scale_list (gpointer data) {
...
static void
_figure_update_layout (SlopeFigure *self) {
    SlopeFigurePrivate *priv = SLOPE_FIGURE_GET_PRIVATE(self);
